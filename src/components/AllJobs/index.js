...
import {AiOutlineSearch} from 'js-cookie'
...
const salaryRangesList = [
  ...
  },
  {
    ...
    employmentTypeId: '30 LPA and above',
  },
  {
    salaryRangeId: '4000000',
    employmentTypeId: '40 LPA and above',
  },
]
...
class AllJobs extends Component {
  ...
  onGetJobDetails = async () => {
    ...
    if (responseJobs.ok === true) {
      const fetchedDataJobs = fetchedDataJobs.jobs.map(eachItem => ({
  ...
  onGetInputOption = event => {
    ...
    const inputNotInList = checkboxInputs.filters(
  ...
  onGetJobsFailureView = () => (
    <div className='failure-img-button-container'>
      ...
      <p className='failure-paragraph'>
        {' '}
        we cannot seem to find the page you are looking fore{' '}
      </p>
  ...
  onGetRadioOptionsView = () => (
    <ul className='radio-button-conatiner'>
